        ...
        */
        ...
        tauTiamas = new BetterPlanet("tauTiamas", Planets.sun, 1f ,3){{
            ...
            meshLoader = () -> new MultiMesh(
                    new BetterPlanet.AtmosphereHexMesh(6),
                    new HexMesh(this, 6),
                    new HexSkyMesh(this, 11, 0.95f, 0.04f, 6, Color.valueOf("c2c2e2").a(0.35f), 8, 0.45f, 1.6f, 0.5f),
                    new HexSkyMesh(this, 1, 1.3f, 0.05f, 6, Color.valueOf("c2c2e2").a(0.45f), 6, 0.45f, 0.6f, 0.21f),
        ...
        siran = new BetterPlanet("siran", ExoPlanets.zetaTitanus, 2.6f, 0){{
            ...
            cloudMeshLoader = () -> new MultiMesh(
                    new HexSkyMesh(this, 2, 1f, 0.04f, 6, Color.valueOf("3c36ce").a(0.6f), 2, 0.8f, 1f, 0.f),
                    new HexSkyMesh(this, 3, -1.3f, 0.05f, 6, Color.valueOf("5a55d0").a(0.6f), 2, 0.8f, 1f, 0.5f),
                    new HexSkyMesh(this, 4, 1.3f, 0.06f, 6, Color.valueOf("7259af").a(0.6f), 2, 0.8f, 1.2f, 0.5f),
                    new HexSkyMesh(this, 5, -1.6f, 0.07f, 6, Color.valueOf("7a7dde").a(0.6f), 2, 0.8f, 1.2f, 0.5f)
            );
        }};
    }
