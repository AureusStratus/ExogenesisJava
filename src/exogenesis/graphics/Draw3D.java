...
public class Draw3D{
    /** Arbitrary value that translates z coordinate in world units to camera offset height. Code from Meep! */
        ...
        Events.run(Trigger.drawOver, () -> {
            if(shadowQueue.any()){
                Draw.draw(shadowLayer, () -> {
                    ...
                    buffer.blit(OtherExoShaders.passThrough);
                });
                shadowQueue.clear();
            }
