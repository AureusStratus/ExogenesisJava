package exogenesis.graphics.trails;
...
public class ExoTrail extends Trail{ //Taken from Project Unity and modified a bit
    private final FloatSeq points;
    private float lastX = -1, lastY = -1, counter = 0f;

    public ExoTrail(int length){
        super(length);
    ...
    public ExoTrail copyPM(){
        ExoTrail out = new ExoTrail(length);
