...
import exogenesis.content.ExoPlanets;
...
public class CircleMesh extends PlanetMesh{
    ...
    public void preRender(PlanetParams params){
        ExoShaders.planetTextureShader.planet = planet;
        ExoShaders.planetTextureShader.lightDir
                .set(planet.solarSystem.position)
                .sub(planet.position)
                .rotate(Vec3.Y, planet.getRotation())
                .nor();
        ExoShaders.planetTextureShader.ambientColor
                .set(planet.solarSystem.lightColor);
        //TODO: better disappearing
        ExoShaders.planetTextureShader.alpha = params.planet == planet ? 1f - params.uiAlpha : 1f;
    }
    ...
    private static Shader shader(){
        return ExoShaders.planetTextureShader;
    }
}