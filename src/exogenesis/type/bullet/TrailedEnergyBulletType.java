...
public class TrailedEnergyBulletType extends AccelBulletType{
    ...
    public TrailedEnergyBulletType(float speed, float damage, String bulletSprite) {
        ...
        if(!Vars.headless && (b.data instanceof Vec2Seq[])){
            ...
            for(Vec2Seq points : pointsArr){
                ...
                if(despawnBlinkTrail || (b.absorbed && hitBlinkTrail)){
                    ...
                    ExoFx.hitEmpColorSpark.at(v.x, v.y, hitColor);
                }else{
                    points.add(tracerStroke, tracerFadeOffset);
                    ExoFx.lightningFade.at(b.x, b.y, tracerStrokeOffset, hitColor, points);
                }
            }
