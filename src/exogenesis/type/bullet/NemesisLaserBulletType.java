...
import static exogenesis.util.util.Utils.collideLineRawEnemyRatio;

public class NemesisLaserBulletType extends BulletType{
    float length = 250f;
    float lengthFalloff = 0.6f;
    float sideLength = 29f, sideWidth = 0.7f;
    float sideAngle = 90f;

    Color[] colors = {ExoPal.erekirPurple.cpy().mul(0.9f).a(0.3f), ExoPal.erekirPurple, Color.white};

    public NemesisLaserBulletType(float damage){
        super(0f, damage);
